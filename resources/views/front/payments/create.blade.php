<x-front-layout>
    ...
    <script>
        // This is your test publishable API key. PUBLISHABLE_KEY 
        console.log("{{ config('services.stripe.publishable_key') }}");
        // console.log("{{ config('services.stripe.secret_key') }}");
  ...
  <path d="M5.75 4C5.75 3.31075 6.31075 2.75 7 2.75C7.68925 2.75 8.25 3.31075 8.25 4C8.25 4.68925 7.68925 5.25 7 5.25C6.31075 5.25 5.75 4.68925 5.75 4Z" fill="white"/>
        ...
        // Stripe.js instance
        // const stripe = Stripe("pk_test_51QYe1NIcaHNrHBWHxAs5vtXw8TpXhu6IcGmRctLRQ8a9hLLkgDRDmtIgMdQ3Rj7iBQOIjv4aRcdMH2mFBLBlYGOQ00fZZvSO7P");
